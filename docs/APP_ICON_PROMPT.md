...
- **Core symbol:** one four-point sparkle, with long vertical points and shorter
  horizontal points. It must read as a cross-shaped sparkle, never a five-point
  star.
...
- **Color:** warm clay orange and apricot, with soft cream highlights and a deep
  ...
  products without copying any specific brand palette or asset.
- **Material:** restrained soft-clay depth, a soft upper-left tile highlight,
  gentle radial inner light, cream edge lighting on the sparkle, and controlled
  contact shadows. Avoid glassiness, neon, or a visible halo ring.
- **Channel:** macOS rounded-square app icon, 1:1, authored at 1024 x 1024 px.
...
the sparkle but not touching it, tilted approximately 8 degrees to the left. The
Z uses a minimal rounded sans-serif form with medium weight and excellent
legibility at 16 px.

Use a lively warm clay-orange and apricot palette: a terracotta-orange background
with a subtle tonal gradient, a warm cream or pale peach sparkle, and a deep cocoa
Z. Add restrained soft-clay dimensionality, a soft upper-left rim highlight,
gentle radial inner light, brighter cream edge lighting, and controlled contact
shadows, while keeping the silhouette bold, uncluttered, and readable at small
app-icon sizes. The overall feeling is alert but calm, playful but capable,
friendly, contemporary, and distinctly macOS-native. No words, no product name,
no extra symbols.

Strict constraints: one four-point sparkle and one Z only; no five-point star,
...
State the count and geometry twice: exactly one four-point cross-shaped sparkle
and exactly one uppercase Z. Request a 1:1, 1024 px result and verify the Z tilt,
safe margins, and small-size legibility after generation.

### Midjourney

Lead with `four-point cross-shaped sparkle, one uppercase Z, warm clay-orange
macOS app icon`. Use `--ar 1:1 --stylize 80`. Letterforms may be unreliable, so
generate the symbol composition first and replace the Z with licensed typography
during final production if necessary.

### GPT-Image-2

Use the universal prompt directly. For revisions, say: “Preserve the exact
four-point sparkle geometry and single-Z placement; simplify the material,
increase the negative space, and verify recognition at 16 px.”

## Review Checklist

- The central form has exactly four points and cannot be mistaken for a
  five-point star.
